...
//read the team ids and scores from the dartt.txt file into the arrays
void readFromFile(FILE * inp, int teams[], int scores[][GAME], int *noOfTeams);
...
int main(void)
{
	...
	else
	{
		...
		double teamAvg[TEAM],
			gameAvg[GAME];
		//read the team ids and scores from the dart.txt file into the arrays
